...
class_names = []
with open("E:/Users_Data/Vamshi/Projects/AI/object_detection/yolo_weights/darknet/data/coco.names", "r") as f:
    class_names = [cname.strip() for cname in f.readlines()]
 
weapon_classes = []
with open("E:/Users_Data/Vamshi/Projects/AI/object_detection/weapon-detection/obj.names", "r") as f:
    weapon_classes = [line.strip() for line in f.readlines()]
 
# Setting up OpenCV net for object detection
yoloNet_obj = cv2.dnn.readNet("E:/Users_Data/Vamshi/Projects/AI/object_detection/yolo_weights/yolov7-tiny.weights", "E:/Users_Data/Vamshi/Projects/AI/object_detection/yolo_weights/darknet/cfg/yolov7-tiny.cfg")
...
yoloNet_weapon = cv2.dnn.readNet("E:/Users_Data/Vamshi/Projects/AI/object_detection/weapon-detection/yolov2-tiny-custom_200000.weights", "E:/Users_Data/Vamshi/Projects/AI/object_detection/weapon-detection/yolov2-tiny.cfg")
